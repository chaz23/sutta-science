...
for (i in groups) {
  ...
  body_section <- list(model = "text-embedding-3-large", 
...
save(embeddings_by_section_pre_umap_dn, 
     file = "./data-generation/text-embeddings/embeddings_by_section_dn_large.Rda")
save(embeddings_by_section_pre_umap_mn, 
     file = "./data-generation/text-embeddings/embeddings_by_section_mn_large.Rda")
save(embeddings_by_section_pre_umap_an, 
     file = "./data-generation/text-embeddings/embeddings_by_section_an_large.Rda")
save(embeddings_by_section_pre_umap_sn, 
     file = "./data-generation/text-embeddings/embeddings_by_section_sn_large.Rda")
save(embeddings_by_section_pre_umap_kn, 
     file = "./data-generation/text-embeddings/embeddings_by_section_kn_large.Rda")

save(embeddings_by_section,
     file = "./data-generation/text-embeddings/embeddings_by_section_large.Rda")

write.csv(embeddings_by_section, 
          file = "./data-generation/text-embeddings/embeddings_by_section_large.csv", 
          row.names = FALSE)